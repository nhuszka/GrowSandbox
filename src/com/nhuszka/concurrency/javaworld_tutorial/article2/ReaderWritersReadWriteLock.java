...
// http://www.javaworld.com/article/2078848/java-concurrency/java-concurrency-java-101-the-next-generation-java-concurrency-without-the-pain-part-2.html?page=2
public class ReaderWritersReadWriteLock {
		...
		Runnable wrunnable = new Runnable() {
			...
			public void run() {
				for (int i = 0; i < NUMITER; i++) {
					names.add(Thread.currentThread().getName(), "val" + i);
					try {
						Thread.sleep(DELAY);
